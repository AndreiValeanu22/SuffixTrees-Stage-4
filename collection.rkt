...
(define-syntax-rule (collection-car list) (stream-first list))
(define-syntax-rule (collection-cdr list) (stream-rest list))
(define-syntax-rule (collection-map func list) (stream-map func list))
(define-syntax-rule (collection-filter func list) (stream-filter func list))
(define-syntax-rule (collection-empty? list) (stream-empty? list))
